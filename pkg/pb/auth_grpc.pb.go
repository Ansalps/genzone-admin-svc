...
const (
	AuthService_Login_FullMethodName    = "/admin.AuthService/Login"
	AuthService_Validate_FullMethodName = "/admin.AuthService/Validate"
)
...
func (c *authServiceClient) Login(ctx context.Context, in *AdminLoginRequest, opts ...grpc.CallOption) (*AdminLoginResponse, error) {
...
func (UnimplementedAuthServiceServer) Login(context.Context, *AdminLoginRequest) (*AdminLoginResponse, error) {
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Login(ctx, req.(*AdminLoginRequest))
	}
